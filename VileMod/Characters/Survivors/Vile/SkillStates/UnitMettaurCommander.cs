...
{
    public class UnitMettaurCommander : BaseSkillState
    {
        ...
        public override void OnEnter()
        {
            ...
            if (VBC.GetBoltValue() < boltCost)
            {
                ...
                Chat.AddMessage($"You need at least {boltCost} Vile Bolts to call Mettaur Commander unit! You currently have {VBC.GetBoltValue()} Vile Bolts.");
        ...
        private void Fire()
        {
            if (!hasFired)
            {
                ...
                if (isAuthority)
                {
                    ...
                    ShotgunProjectille.projectilePrefab = VileAssets.unitMettaurCommanderPrefab;
                    ...
                    if (NetworkServer.active)
                    {
                        ...
                        characterBody.AddTimedBuff(VileBuffs.MetComBuff, 59f);
                    }
