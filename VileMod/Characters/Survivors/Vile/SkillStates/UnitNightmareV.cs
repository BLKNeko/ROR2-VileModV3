...
namespace VileMod.Survivors.Vile.SkillStates
{
    ...
    {
        public static float damageCoefficient = VileStaticValues.UnitNightmareVDamageCoefficient;
        ...
        public override void OnEnter()
        {
            ...
            muzzleString = "Muzzle";
            boltCost = VileStaticValues.UnitNightmareBoltCostt;
            ...
            if (VBC.GetBoltValue() < boltCost)
            {
                ...
                Chat.AddMessage(
                    ...
                    $"<color=#00BFFF>Nightmare Virus Unit</color>! You currently have " +
