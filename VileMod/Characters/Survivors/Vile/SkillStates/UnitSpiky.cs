...
{
    public class UnitSpiky : BaseSkillState
    {
        ...
        public override void OnEnter()
        {
            ...
            if (VBC.GetBoltValue() < boltCost)
            {
                ...
                Chat.AddMessage($"You need at least {boltCost} Vile Bolts to call Spiky unit! You currently have {VBC.GetBoltValue()} Vile Bolts.");
        ...
        private void Fire()
        {
            if (!hasFired)
            {
                ...
                if (isAuthority)
                {
                    ...
                    ShotgunProjectille.projectilePrefab = VileAssets.unitSpikyPrefab;
