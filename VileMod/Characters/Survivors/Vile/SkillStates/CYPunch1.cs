...
{
    public class CYPunch1 : BaseMeleeAttackNeko2
    {
        public override void OnEnter()
        {
            ...
            SetNextEntityState(new CYPunch2());
        ...
        protected override void PlayAttackAnimation()
        {
            ...
            PlayAnimationOnAnimator(customAnimator, "Gesture, Override", "CY_ATK0_1", playbackRateParam, duration * 0.8f, 0.1f * duration);
        }
