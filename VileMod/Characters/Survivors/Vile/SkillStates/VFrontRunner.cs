...
{
    public class VFrontRunner : BaseSkillState
    {
        public static float damageCoefficient = VileStaticValues.VFrontRunnerDamageCoefficient;
        ...
        private void Fire()
        {
            if (!hasFired)
            {
                ...
                if (isAuthority)
                {
                    ...
                    VProjectille.projectilePrefab = VileAssets.FrontRunnerFireBallProjectile;
