...
{
    public class EnterCyclops : BaseSkillState
    {
        ...
        public override void OnEnter()
        {
            ...
            boltCost = VileStaticValues.RideArmorCyclopsCost; //Set the cost of entering Goliath mode
            ...
            if (VBC.GetBoltValue() < boltCost && !characterBody.HasBuff(VileBuffs.RideArmorEnabledBuff)) 
            {
                ...
                Chat.AddMessage(
                    ...
                    $"<color=#00BFFF>Cyclops Ride Armor</color>! You currently have " +
        ...
        public override void FixedUpdate()
        {
            ...
            if (fixedAge >= duration && isAuthority)
            {
                ...
                outer.SetNextState(new EnterCyclopsEnd());
                return;
            }
        }
