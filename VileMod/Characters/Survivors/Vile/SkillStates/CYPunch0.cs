...
{
    public class CYPunch0 : BaseMeleeAttackNeko2
    {
        ...
        protected override void PlayAttackAnimation()
        {
            ...
            PlayAnimationOnAnimator(customAnimator, "Gesture, Override", "CY_ATK0_0", playbackRateParam, duration * 0.8f, 0.1f * duration);
        }
