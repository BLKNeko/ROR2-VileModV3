...
namespace VileMod.Modules.Achievements
{
    ...
    {
        public override string AchievementTokenPrefix => VilePlugin.DEVELOPER_PREFIX + "_HENRY_BODY_MASTERY";
        ...
        public override string PrerequisiteUnlockableIdentifier => VilePlugin.DEVELOPER_PREFIX + "_HENRY_BODY_UNLOCKABLE_REWARD_ID";
